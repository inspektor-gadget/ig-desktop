<script lang="ts">
	...
	const xAccessorScaled = $derived((d: unknown) => xScale(xAccessor(d as DataPoint)));
	const yAccessorScaled = $derived((d: unknown) => yScale(yAccessor(d as DataPoint)));
...
<div class="Timeline placeholder" bind:clientWidth={width} bind:clientHeight={height}>
	<Chart dimensions={dms}>
		<defs>
			<Gradient id={gradientId} colors={gradientColors} x1="0" y1="0" x2="0" y2="100%" />
		</defs>
