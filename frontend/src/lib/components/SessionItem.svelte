...
<div
	class="group/item rounded-lg border border-gray-800 bg-gray-900/50 p-4 transition-all hover:border-green-500/50 hover:bg-gray-900"
>
	<div class="flex flex-row items-start justify-between gap-4">
		...
		>
			<div class="flex flex-row items-center gap-2">
				<span class="font-medium text-gray-200">{session.name || 'Unnamed Session'}</span>
				<span class="rounded bg-green-500/20 px-2 py-0.5 text-xs text-green-400"
