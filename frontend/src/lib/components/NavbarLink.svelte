...
{#snippet content()}
	<div class="absolute -left-3 flex h-full items-center">
		<div
			...
			} w-1 origin-left rounded-r-ig-sm bg-ig-text transition-all duration-200`}
		></div>
	</div>
	<div class="group-active:translate-y-px">
		<div
			class={`${
				!active
					? 'bg-brand rounded-ig-lg text-ig-text'
					: 'group-hover:bg-brand rounded-3xl bg-ig-border text-ig-text group-hover:rounded-ig-lg group-hover:text-ig-text'
