	...
	{#if inspect}
		<table class="w-full max-w-full border-b border-gray-800">
			<thead class="sticky top-0">
				<tr class="bg-gray-950 text-xs uppercase">
					<th class="border-r border-gray-800 p-2 font-normal">Key</th>
			...
			<tbody>
				{#each inspect.fields as field}
					<tr>
						<td class="border-r border-gray-800 px-2 py-1 text-gray-400">{field.fullName}</td>
